// -----------------------------------------------------------------------------------------------------------------
// <copyright file="ThemeManager.cs" company="dwndland">
...
public static class ThemeManager
{
    ...
    private static readonly List<Window> _systemThemeWindows = [];
    ...
    private static readonly List<Window> _servantWindows = [];
